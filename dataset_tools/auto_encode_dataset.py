import sys
sys.path.append('../')
from neural_nets.auto_encoder import auto_encoder
from neural_nets.classifier import classifier
from dataset_tools.encode_dataset import x_train, y_train, x_test, y_test
from dataset_tools.encode_dataset import encoded_x_train_clr0, encoded_y_train_clr0, encoded_x_test_clr0, encoded_y_test_clr0
from dataset_tools.encode_dataset import encoded_x_train_clr1, encoded_y_train_clr1, encoded_x_test_clr1, encoded_y_test_clr1
import numpy as np
